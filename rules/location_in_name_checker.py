        ...
        for row in reader:
            ...
            for field in row:
                if field.lower() in namelist:
                    ...
                    resulttext = str(
                        placename) + " § 12.(5) Kui ärinimi lisaks äriühingule viitavale täiendile sisaldab riigi, haldusüksuse või muu koha nime, peab ärinimi sisaldama riigi, haldusüksuse või muu koha nimest eristavat täiendit. \n§ 12.(6) Ärinimes ei või kasutada riigi või kohaliku omavalitsuse organite ja asutuste nimetusi. \n§ 8.(2) Füüsilisest isikust talupidaja ärinimi ei pea sisaldama ettevõtja ees- ja perekonnanime juhul, kui ärinimes sisaldub talu nimi."
                    breakflag = True
                    break
            if breakflag:
                break

    return not breakflag, resulttext
